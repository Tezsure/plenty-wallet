...
import 'package:plenty_wallet/app/modules/nft_gallery/view/nft_detail_sheet.dart';
...
import '../../account_summary/views/pages/nft_tab.dart';
...
//     );
  ...
  final refreshListController = RefreshController();
      ...
      Expanded(
        child: SmartRefresher(
          ...
          onRefresh: () async {
            ...
            await controller.fetchAllNftForGallery();
  ...
  final refreshCollectionController = RefreshController();
      ...
      Obx(
        () => Expanded(
          child: SmartRefresher(
            ...
            enablePullDown: true,
            enableTwoLevel: true,
            controller: refreshCollectionController,
            onRefresh: () async {
              controller.offsetContract = 0;
              controller.contracts.clear();
              controller.galleryNfts.clear();
              controller.nftList.clear();
              await controller.fetchAllNftForGallery();
              refreshCollectionController.refreshCompleted();
            },
    ...
    return Obx(() {
      return NaanBottomSheet(
        leading: BouncingWidget(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: 0.arP),
            ...
            child: Column(
              children: [
                ...
                ListView.builder(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: controller.nftGalleryList[index]
                                                .imageType ==
                                            AccountProfileImageType.assets
                                        ? AssetImage(controller
                                            .nftGalleryList[index].profileImage
                                            .toString())
                                        : FileImage(
                                            File(
                                    ...
                                    child: Align(
                                        ...
                                        child: PopupMenuButton(
                                          ...
                                          shape: RoundedRectangleBorder(
                                              borderRadius:
                                                  BorderRadius.circular(8.arP)),
                                          color: const Color(0xff421121),
                                          padding: EdgeInsets.zero,
                                          itemBuilder: (_) {
                                            controller.isTransactionPopUpOpened
                                                .value = true;
                  ...
                  itemCount: controller.nftGalleryList.length,
                ),
                0.02.vspace,
                BouncingWidget(
                  onPressed: () async {
