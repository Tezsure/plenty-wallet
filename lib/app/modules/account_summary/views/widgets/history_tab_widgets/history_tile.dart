...
import 'expandable_history_tile.dart';
...
class HistoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (tokenInfo.internalOperation.isNotEmpty &&
        !tokenInfo.internalOperation
            .every((element) => element.dollarAmount == 0.0)) {
      return ExpandableHistoryTile(
        xtzPrice: xtzPrice,
        tokenInfo: tokenInfo,
        onTap: onTap,
      );
    }
    // if (!tokenInfo.isNft && tokenInfo.dollarAmount == 0.0) return Container();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: labelLarge.copyWith(
                                  fontWeight: FontWeight.w400,
                                  color: tokenInfo.token!.operationStatus ==
                                          'applied'
                                      ? tokenInfo.isSent
                                          ? Colors.white
