...
/// [NaanExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [NaanExpansionTile].
///
/// {@tool dartpad}
...
class NaanExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const NaanExpansionTile({
    super.key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<NaanExpansionTile> createState() => _NaanExpansionTileState();
}

class _NaanExpansionTileState extends State<NaanExpansionTile>
