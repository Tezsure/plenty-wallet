...
/// Defines the title font used for [NaanListTile] descendants of a [ListTileTheme].
///
...
enum ListTileStyle {
  /// Use a title font that's appropriate for a [NaanListTile] in a list.
  list,

  /// Use a title font that's appropriate for a [NaanListTile] that appears in a [Drawer].
  drawer,
}

/// Where to place the control in widgets that use [NaanListTile] to position a
/// control next to a label.
///
/// See also:
///
///  * [CheckboxListTile], which combines a [NaanListTile] with a [Checkbox].
///  * [RadioListTile], which combines a [NaanListTile] with a [Radio] button.
///  * [SwitchListTile], which combines a [NaanListTile] with a [Switch].
///  * [ExpansionTile], which combines a [NaanListTile] with a button that expands
///    or collapses the tile to reveal or hide the children.
enum NaanListTileControlAffinity {
...
/// are not painted by the [NaanListTile] itself but by the [Material] widget
...
/// {@end-tool}
///
/// ## Performance considerations when wrapping [NaanListTile] with [Material]
///
/// Wrapping a large number of [NaanListTile]s individually with [Material]s
/// is expensive. Consider only wrapping the [NaanListTile]s that require it
/// or include a common [Material] ancestor where possible.
///
/// [NaanListTile] must be wrapped in a [Material] widget to animate [tileColor],
...
///
/// {@tool dartpad}
/// This example showcases how [NaanListTile] needs to be wrapped in a [Material]
...
/// {@tool snippet}
///
/// To use a [NaanListTile] within a [Row], it needs to be wrapped in an
/// [Expanded] widget. [NaanListTile] requires fixed width constraints,
...
/// See also:
///
///  * [ListTileTheme], which defines visual properties for [NaanListTile]s.
///  * [ListView], which can display an arbitrary number of [NaanListTile]s
///    in a scrolling list.
///  * [CircleAvatar], which shows an icon representing a person and is often
///    used as the [leading] element of a ListTile.
///  * [Card], which can be used with [Column] to show a few [NaanListTile]s.
///  * [Divider], which can be used to separate [NaanListTile]s.
///  * [NaanListTile.divideTiles], a utility for inserting [Divider]s in between [NaanListTile]s.
///  * [CheckboxListTile], [RadioListTile], and [SwitchListTile], widgets
///    that combine [NaanListTile] with other controls.
...
class NaanListTile extends StatelessWidget {
  /// Creates a list tile.
  ///
  ...
  ///
  /// Insets a [NaanListTile]'s contents: its [leading], [title], [subtitle],
  ...
  /// The minimum width allocated for the [NaanListTile.leading] widget.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    return BouncingWidget(
      ...
      onLongPressed: enabled ? onLongPress : null,
      child: Semantics(
        selected: selected,
        enabled: enabled,
        child: Ink(
